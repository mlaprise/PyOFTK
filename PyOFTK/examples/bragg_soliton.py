...
[u_plus, u_moins, u_plus_archive, u_moins_archive, detecteur] = PyOFTK.ossmgpu3(champ_in, fbg1.length, nt, 0.0, fbg1.beta1(LMBD), kapVec, detVec, gamma, 50, 1.0, positionDetecteur)
