...
[u_plus, u_moins, u_plus_archive, u_moins_archive, detecteur] = PyOFTK.ossmgpu2(champ_in, fbg1.length, nt, alphaVec, fbg1.beta1(LMBD), kapVec, detVec, gamma, 100, 1.0, positionDetecteur)
...
PyOFTK.ossmOutputMP4('litchinitser1997analysis_fig10b_lin',u_plus_archive.T,u_moins_archive.T, z*1000, kapVec, 20, 0, 0)
