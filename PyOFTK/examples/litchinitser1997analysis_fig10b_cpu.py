# *********************************************
#	Compute the figure 10 (b) of
#	
#	Litchinitser et al. 1997
#	Analysis of Fiber Bragg Gratings for 
#	dispersion compensation in Reflective and 
#	transmissive Geometries
#
#	Use ossm() function instead of the gpu
#	accelerated function ossmgpu2()
#
...
try:
	 u_out_x1 = PyOFTK.hdf5load("data/100km1.h5")
except:
	T = nbrPoints_z * dt
...
[u_plus, u_moins, u_plus_archive, u_moins_archive, detecteur] = PyOFTK.ossm(champ_in, fbg1.length, nt, alphaVec, fbg1.beta1(LMBD), kapVec, detVec, gamma, 100, 1.0, positionDetecteur)

elapsed = time.time() - t1
print "********* Parametre de la simulation ********* "
print "Input pulse energy: " + str(pow(abs(pulse),2).sum()*dt) + " nJ"
print "Output pulse energy: " + str(pow(abs(u_plus),2).sum()*dt) + " nJ"
...
print "Effective Beta2 : " + str(fbg1.gBeta2(LMBD)*1e24) + " ps2/m"
print "Effective Beta3 : " + str(fbg1.gBeta3(LMBD)*1e36) + " ps3/m"
print "********************************************** "
...
PyOFTK.ossmOutputMP4('litchinitser1997analysis_fig10b',u_plus_archive.T,u_moins_archive.T, z*1000, kapVec, 20, 0, 0)
